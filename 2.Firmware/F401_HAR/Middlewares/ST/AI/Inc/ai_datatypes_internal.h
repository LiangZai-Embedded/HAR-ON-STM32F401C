...
#define AI_SHAPE_D(shape_)          ((AI_SHAPE_SIZE((shape_)) >= 5) ? AI_SHAPE_ELEM((shape_), AI_SHAPE_DEPTH) : 1)
#define AI_SHAPE_E(shape_)          ((AI_SHAPE_SIZE((shape_)) == 6) ? AI_SHAPE_ELEM((shape_), AI_SHAPE_EXTENSION) : 1)
