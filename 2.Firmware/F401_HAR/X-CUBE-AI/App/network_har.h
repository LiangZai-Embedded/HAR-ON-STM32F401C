...
#ifndef AI_NETWORK_HAR_H
#define AI_NETWORK_HAR_H
#pragma once
...
/******************************************************************************/
#define AI_NETWORK_HAR_MODEL_NAME          "network_har"
#define AI_NETWORK_HAR_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_NETWORK_HAR_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_NETWORK_HAR_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_HAR_IN \
  ai_network_har_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_HAR_IN_SIZE { \
  AI_NETWORK_HAR_IN_1_SIZE, \
}
#define AI_NETWORK_HAR_IN_SIZE_BYTES { \
  AI_NETWORK_HAR_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_HAR_IN_1_HEIGHT      (90)
#define AI_NETWORK_HAR_IN_1_WIDTH       (3)
#define AI_NETWORK_HAR_IN_1_CHANNEL     (1)
#define AI_NETWORK_HAR_IN_1_SIZE        (90 * 3 * 1)
#define AI_NETWORK_HAR_IN_1_SIZE_BYTES  (1080)

/******************************************************************************/
#define AI_NETWORK_HAR_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_HAR_OUT \
  ai_network_har_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_HAR_OUT_SIZE { \
  AI_NETWORK_HAR_OUT_1_SIZE, \
}
#define AI_NETWORK_HAR_OUT_SIZE_BYTES { \
  AI_NETWORK_HAR_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_HAR_OUT_1_CHANNEL     (6)
#define AI_NETWORK_HAR_OUT_1_SIZE        (6)
#define AI_NETWORK_HAR_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_NETWORK_HAR_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_har
 ...
 * @ref ai_network_har_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_har_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_har_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_har_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_HAR_*
 * defines into file @ref network_har.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_har_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_HAR_H */
